...
## render face-down mini card reads backArtwork.minimal from DeckContext
...
## render JOKER mini card abbreviates the value instead of truncating
...
## render JOKER micro card abbreviates the value instead of overflowing
