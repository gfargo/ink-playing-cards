...
## render no cards when maxDisplay is 0
...
## render minimal variant face down horizontal stack without border bleed
...
## vertical overlap merges equal-width card borders without a gap
...
## vertical overlap still overlaps at mini scale instead of collapsing to zero
...
## vertical overlap still overlaps at micro scale instead of collapsing to zero
...
## render stack with a tarot card
...
## render stack with mixed standard and tarot cards
